...
final class YouTrackIssueTrackerClient implements IssueTrackerClientInterface
{
    ...
    {
        // TODO: implement YouTrack REST API integration
        return [];
    }
    ...
    {
        // TODO: implement YouTrack REST API integration
        return new IssueData('', null, $data['title'], IssueStatus::Open, null, null, [], TrackerType::YouTrack);
    }
}
